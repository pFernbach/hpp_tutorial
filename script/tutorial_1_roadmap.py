...
v.displayRoadmap("rmR",0.02,1,v.color.blue,v.color.lightBlue,'r_gripper_r_finger_tip_joint')
v.displayRoadmap("rmL",0.02,1,v.color.green,v.color.lightGreen,'l_gripper_r_finger_tip_joint')
...
# v.solveAndDisplay("rmL2",2,0.02,1,v.color.green,v.color.lightGreen,'l_gripper_r_finger_tip_joint')
# v.displayRoadmap( "rmR1"  ,0.02,1,v.color.blue ,v.color.lightBlue ,'r_gripper_r_finger_tip_joint')
# solveAndDisplay show the construction of the roadmap, the first int set the refresh rate of the display (here, every 2 iteration of the algorithm) Warning : this slow down the resolution time
################################################################
...
pp.displayPath(0     , v.color.lightBlack    ,'r_gripper_r_finger_tip_joint')
pp (0)
#display path after optimisation
pp.displayPath(1,v.color.lightRed,'r_gripper_r_finger_tip_joint')
pp (1)
